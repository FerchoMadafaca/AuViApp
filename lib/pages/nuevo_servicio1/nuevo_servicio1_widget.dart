...
import 'nuevo_servicio1_model.dart';
export 'nuevo_servicio1_model.dart';

class NuevoServicio1Widget extends StatefulWidget {
  const NuevoServicio1Widget({super.key});

  @override
  State<NuevoServicio1Widget> createState() => _NuevoServicio1WidgetState();
}

class _NuevoServicio1WidgetState extends State<NuevoServicio1Widget> {
  late NuevoServicio1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NuevoServicio1Model());
              ...
              child: Column(
                ...
                children: [
                  Align(
                    ...
                    child: Text(
                      '\nNuevo Servicio Lavado de Autos\n',
                                ...
                                child: FlutterFlowDropDown<String>(
                                  controller:
                                      _model.dropDownValueController2 ??=
                                          FormFieldController<String>(null),
                                  options: ['Exterior', 'Interior', 'Completo'],
                                  onChanged: (val) => setState(
