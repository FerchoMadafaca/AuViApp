...
import 'nuevo_servicio2_model.dart';
export 'nuevo_servicio2_model.dart';

class NuevoServicio2Widget extends StatefulWidget {
  const NuevoServicio2Widget({super.key});

  @override
  State<NuevoServicio2Widget> createState() => _NuevoServicio2WidgetState();
}

class _NuevoServicio2WidgetState extends State<NuevoServicio2Widget> {
  late NuevoServicio2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NuevoServicio2Model());
            ...
            Column(
              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 155.0),
