...
import 'nuevo_servicio3_model.dart';
export 'nuevo_servicio3_model.dart';

class NuevoServicio3Widget extends StatefulWidget {
  const NuevoServicio3Widget({super.key});

  @override
  State<NuevoServicio3Widget> createState() => _NuevoServicio3WidgetState();
}

class _NuevoServicio3WidgetState extends State<NuevoServicio3Widget> {
  late NuevoServicio3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NuevoServicio3Model());
